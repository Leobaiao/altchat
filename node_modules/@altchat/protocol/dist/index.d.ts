...
export type AICommand = ShowMessageCommand | RequestInputCommand | ShowButtonsCommand | ShowFormCommand | UploadFileCommand | WaitCommand | RedirectCommand | ClearCommand | CloseCommand;
...
export type FieldType = "text" | "textarea" | "email" | "phone" | "cpf" | "cnpj" | "number" | "date" | "datetime" | "select" | "radio" | "checkbox" | "file";
...
export type ClientEvent = SessionStartedEvent | UserMessageEvent | UserInputEvent | ButtonClickedEvent | OptionSelectedEvent | FormSubmittedEvent | FileUploadedEvent | SessionClosedEvent;
